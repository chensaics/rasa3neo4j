...
class CustomFallbackAction(Action):
    ...
    async def run(
        ...
        dispatcher.utter_message(text='action_fallbacks 默认回复：你说的我还不懂，我再努力学习一下')
        return []
...
class ActionFirst(Action):
    ...
    def run(self,
        ...
        dispatcher.utter_message(text="您可以这样向我提问: "
                                      "<br/>头痛怎么办<br/>\
                              什么人容易头痛<br/>\
                              头痛吃什么药<br/>\
                              头痛能治吗<br/>\
...
class ActionDonKnow(Action):
    ...
    def run(self,
        ...
        dispatcher.utter_message(text="您可以这样向我提问: <br/>头痛怎么办<br/>\
                                      什么人容易头痛<br/>\
                                      头痛吃什么药<br/>\
                                      头痛能治吗<br/>\
                                      头痛属于什么科<br/>\
    ...
    def run(self,
        ...
        if disease == pre_disease or len(possible_diseases) == 1:
            ...
            if 'a.prevent' in a:
                ...
                retmsg = template.format(disease, text=prevent.replace('\n', '<br/>'))
            else:
